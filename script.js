...
const warehouses = {
    ...
    "5ZM82": { name: "Склад 5ZM82", address: "20 корпус", capacity: "координаты: 53.567354, 49.264893" },
    "1F382": { name: "Склад 1F382", address: "12/1 корпус", capacity: "координаты: между ПРП06 и 77Б" },
    "1F989": { name: "Склад 1F989", address: "23 корпус", capacity: "координаты: 53.564886, 49.258801" },
   "5ZM85": { name: "Склад 5ZM85", address: "30 корпус", capacity: "координаты: 53.569386, 49.251220" }
    "КТО ЛОХ?": { name: "Эльвин", address: "УСН 7 кабинет" }
...
function findWarehouse() {
    ...
    if (warehouses[warehouseNumber]) {
        ...
        resultDiv.innerHTML = `
            ...
            <p>Где находится: ${warehouse.address}</p>
